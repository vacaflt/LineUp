<!-- Single.php by Thais Vacaflores
Code to for all single posts
-->
...
?>
  <div class="page-banner">
	...
	<div class="container container--narrow page-section">
      ...
      <p>
        <a class="metabox__blog-home-link" href="<?php echo site_url('/blog'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Announcements Home</a>
